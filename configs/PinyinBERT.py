...
class PinyinBertConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.specials = [self.pad_token, self.cls_token_id, self.empty_token, self.mask_token_id, self.unk_token]
        ...
        phonemes = initials + rhymes + tones + others
